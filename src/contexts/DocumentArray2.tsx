...
const initialDocumentTypes: DocumentType[] = [
  ...
  },
  {
    ...
    {
    id: 16,
    title: "Dealer Inspection Report",
    icon: require("@/assets/icons/rent doc 3.png"),
    uploaded: false,
    documentName: "DEALER INSPECTION REPORT",
    fileUrl: "",
    fileSize: 390,
    fileType: "PDF",
  },
  ...
  {
    id: 18,
    title: "Manufacturers Invoice",
    icon: require("@/assets/icons/invoiceicon.png"),
    uploaded: false,
    documentName: "MANUFACTURERS INVOICE",
    fileUrl: "",
    fileSize: 390,
    fileType: "PDF",
  },
  ...
  {
    id: 21,
    title: "Municipal Tax Pad Certificate",
    icon: require("@/assets/icons/rent doc 3.png"),
    uploaded: false,
    documentName: "MUNICIPAL TAX PAD CERTIFICATE",
    fileUrl: "",
    fileSize: 195,
    fileType: "PDF",
  },
